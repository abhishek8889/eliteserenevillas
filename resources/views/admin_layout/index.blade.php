...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/coustam.css') }}">
                              ...
                              <!-- <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ url('admin-dashboard/import') }}" class="nk-menu-link"><span class="nk-menu-text">Import</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{url('/admin-dashboard/villas')}}" class="nk-menu-link"><span class="nk-menu-text">Listing</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{url('/admin-dashboard/add-Villas')}}" class="nk-menu-link"><span class="nk-menu-text">Add New Listing</span></a>
                                        </li>
                                       
                                    </ul>
                                </li>
                                <li class="nk-menu-item active current-page">
                                    <a href="{{url('admin-dashboard/amenities')}}" class="nk-menu-link">
                                        <span class="nk-menu-icon"><em class="icon ni ni-tile-thumb"></em></span>
                                ...
                                <li class="nk-menu-item active current-page">
                                    <a href="{{url('/admin-dashboard/services')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-tile-thumb"></em></span>
                                ...
                                <li class="nk-menu-item active current-page">
                                    <a href="{{url('/admin-dashboard/catgories')}}" class="nk-menu-link">
                                    <span class="nk-menu-icon"><em class="icon ni ni-tile-thumb"></em></span>
                                        <span class="nk-menu-text">Property Type</span>
                                    </a>
                                    <!-- <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a  href="{{url('/admin-dashboard/destination')}}" class="nk-menu-link"><span class="nk-menu-text">Destination List</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{url('/admin-dashboard/destination/add')}}" class="nk-menu-link"><span class="nk-menu-text">Add New Destination</span></a>
                                        </li>
