...
@section('content')
{{ Breadcrumbs::render('amenities-list') }}
                ...
                <div class="col-sm-6">
                    <form action=""  id="form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="hidden" class="form-control" name="amenitiesSlug" id="amenitiesSlug"
                                    placeholder="Amenities Name">
                            </div>
                        </div>
        ...
        <table class="table table-tranx" id="table">
            ...
            <tbody>
                ...
                <tr class="tb-tnx-item">
                    ...
                    <input type="hidden" data-id="{{ $amenitie->id ?? '' }}" class="titleSlug slug{{ $amenitie->id ?? '' }}" value="{{ $amenitie->slug ?? '' }}"  disabled style="border: none; background: transparent;" /> 
                    <!-- <td class="tb-tnx-info">
                        <div class="tb-tnx-desc">
