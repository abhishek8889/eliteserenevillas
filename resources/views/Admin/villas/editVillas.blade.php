...
@section('content')
{{ Breadcrumbs::render('edit-villa', $villasData) }}
                    ...
                    <div class="col-sm-6">
                         ...
                         <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" name ="ics_url" id="icsurl" value="{{ $villasData->villasics['ics_url'] ?? '' }}">
                                </div>
                             </div>
                         </div>
                    </div>
                                        ...
                                        <div class="form-group col-6">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select name="destination" id="destination" class="form-control">
                                                            ...
                                                            <option value="{{ $d->id ?? '' }}" @if($villasData->destination) @if($d->id == $villasData->destination['id']) selected @endif @endif >{{ $d->heading ?? '' }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
...
<div class="example-alert ">
                 <div class="alert alert-primary alert-icon d-flex justify-content-between">
                      ...
                      <button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#modalDefault">add more custom section</button>
                 </div>
             </div>
             <?php  $num = 1; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Add more custom section</h5>
            </div>
