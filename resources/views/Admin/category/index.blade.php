...
@section('content')
{{ Breadcrumbs::render('property-type-list') }}
<div class="card card-bordered card-preview d-none" id="addnewcard">
    <div class="card-inner">
        <div class="preview-block">
            <div class="d-flex justify-content-between">
                <span class="preview-title-lg overline-title">Add Property Type</span>
                ...
                <div class="col-sm-6">
                    <form action=""  id="form-data">
                        <div class="form-group">
                            ...
                            <label class="form-label" for="name">Property Type</label>
